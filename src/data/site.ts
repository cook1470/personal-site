...
const works: Work[] = [
  ...
  { id: 'fabula', name: 'Fabula', year: '2026', tag: 'AI TRPG', desc: '世界在你行動的空檔偷偷長大。', status: '', link: 'https://fabula.b43096022.workers.dev/', img: '', pos: { left: 56, top: 0 }, rot: 1.8, w: 21, hidden: true },
  ...
  { id: 'three-units', name: '三台車', year: '2026', tag: '夜班派遣', desc: '你只聽得到打電話的人。', status: '', link: 'https://three-units.cook1470.com/', features: ['半夜十一點到清晨六點，你是救護派遣員，手上只有三台車。', '你看不到現場，只能從電話裡的聲音判斷誰先等、誰不能等——而最需要車的人，不一定講得最急。', '一夜約七分鐘，中英文皆可玩。'], img: '/images/works/three-units.jpg', pos: { left: 62, top: 1160 }, rot: 1.6, w: 16 },
...
// 金線的牽法：大致沿時間與系列關係
const allThreads: [string, string][] = [
  ['cktw', 'cooktw'],
  ['cooktw', 'pixitank'],
  ['ryvexia', 'witch'],
  ['witch', 'bingo'],
...
export const threads: [string, string][] = allThreads.filter(
  ([a, b]) => pinned.some((w) => w.id === a) && pinned.some((w) => w.id === b),
);
